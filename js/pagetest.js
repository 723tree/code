    ...
    paging: function(option) {
        ...
        function makePage(start,isHome,isEnd) {  //生成页码
            ...
            for (var i = start; i <= endPage; i++) {
                html += '<span class="page" id="uipage-nav'+ i +'" onclick="mynext()">' + i + "</span>";
            }
        ...
        function init(){   //初始化页码
            ...
            light(obj.find("span").eq(1));
        }
        obj.find(".page").click(function clickFirst(){
            var _this = $(this);
        ...
        obj.find("#next").click(function(){
            ...
            if(pageSize*2+1>=totalPage&&currentIndex == pageSize + 1){
